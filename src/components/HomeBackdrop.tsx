...
const HomeBackdrop = ({ className }: HomeBackdropProps) => {
  return (
    <div className={cn("pointer-events-none absolute inset-0 overflow-hidden", className)}>
      ...
      <div className="absolute -left-[11%] top-[15%] h-[46vh] w-[38vw] rotate-[13deg] rounded-[4.5rem] border border-white/30 bg-white/34 shadow-[0_30px_95px_rgba(181,149,70,0.16)] backdrop-blur-3xl dark:border-white/10 dark:bg-white/[0.05] dark:shadow-[0_28px_120px_rgba(7,5,18,0.55)]" />
      ...
      <div className="absolute right-[-4%] top-[8%] h-[75vh] w-[31vw] rotate-[7deg] rounded-[5rem] border border-primary/14 bg-primary/14 shadow-[0_26px_88px_rgba(155,119,33,0.12)] backdrop-blur-[26px] dark:border-white/10 dark:bg-primary/12 dark:shadow-[0_28px_96px_rgba(38,22,76,0.35)]" />
      <div className="absolute bottom-[-10%] left-[31%] h-[31vh] w-[43vw] -rotate-[8deg] rounded-[5rem] border border-white/22 bg-white/20 shadow-[0_24px_70px_rgba(191,156,73,0.08)] backdrop-blur-[24px] dark:border-white/10 dark:bg-white/[0.03]" />
      ...
      <div className="absolute left-[9%] top-[69%] h-56 w-56 rounded-full bg-white/18 blur-[90px] dark:bg-primary/10" />
      <div className="absolute right-[12%] top-[17%] h-64 w-64 rounded-full bg-primary/16 blur-[105px] dark:bg-primary/14" />
